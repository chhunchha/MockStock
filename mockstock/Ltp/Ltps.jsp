...
<table class="are" border="0" width="100%" align="center">
	<tr>
            <th class="main" width="180px"></th>
		<th class="main">LTPS</th>
...
<table class="are" border="2" width="50%" align="center">
	<tr>
		<!--th class="are">Id </th-->
	...
	<%
		for (int i = 0; i < ltps.size(); i++) {
			...
			out.println("<td class='company'>" + aCompany.getName() + "</td>"
					+ "<td class='company'>" + aLtp.getLtp() + "</td>"
                                        + "<td class='company'>" + aLtp.getDiff() + "</td>");
 ...
 <table class="are" width="100%" align="center">
        <tr>
         ...
         //   if (user.equalsIgnoreCase("admin")) {
                    %>
                <form name="frmSimpleLtp" methog="post" action="Ltp"> <input type="hidden" name="type" value="simple"/><input type="submit" value="Show Simple Page" /></form>
                 <%     //       }
                    %>
            </td>
